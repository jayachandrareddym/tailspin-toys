...
For repository coding and documentation standards (comments, TSDoc/JSDoc, and component Props contracts), see `.github/instructions/coding-standards.md`. These guidelines describe how and where to document exported helpers and component APIs.
